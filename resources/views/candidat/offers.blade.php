...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/myOffers.css') }}">
...
<body>
    ...
    <div class="infos-btnFilter">
        <div class="textsInfo">
            <div class="FtextInfo">Consulta el estado tus solicitudes aqui</div>
    ...
    <div id="filterOverlay" class="overlay hidden">
        <div class="overlay-content">
            ...
            <form id="filterForm" action="{{ route('candidat.offers') }}" method="GET">
                            ...
                            <td>
                                <div class="actions-dropdown">
                                    ...
                                    <div id="dropdown-{{ $index }}" class="dropdown-content">
                                        <a href="#" onclick="requestReview({{ $app->id }})" class="dropdown-item">Solicitar revisión</a>
                                        <a href="#" onclick="confirmDelete({{ $app->id }})" class="dropdown-item text-danger">Salir del proceso</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
            ...
            @foreach ($myApplications as $index => $app)
                <div class="application-card">
                    ...
                    <div class="card-footer">
                        <button onclick="requestReview({{ $app->id }})" class="action-button review">Solicitar revisión</button>
                        <button class="action-button exit" onclick="confirmDelete({{ $app->id }})">
                            Salir del proceso
                        </button>
                    </div>
                </div>
