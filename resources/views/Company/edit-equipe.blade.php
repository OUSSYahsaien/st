        ...
        <main class="profile-content" style="margin-top: 0;">
            ...
            <section id="profile" class="content-section active">
                ...
                <div class="profile-picture-section">
                    ...
                    <div class="profile-upload">
                        <div class="current-picture">
                            @php
                                $personalPicturePath = 'images/team_images/' . $member->personel_pic;
                            @endphp
                            @if ($member->personel_pic && file_exists(public_path($personalPicturePath)))
                                <img id="profile-image" style="background: #fff;" src="{{ asset($personalPicturePath) }}" alt="Foto de perfil" class="profile-img">
                            @else 
                                <img id="profile-image" src="https://placehold.co/99x99" alt="Foto de perfil" class="profile-img">
                            @endif
                        </div>
                ...
                <div class="unique-form-container">
                    ...
                    <form action="{{ route('company.update.second.infos', ['id' => $member->id]) }}" method="post" id="unique-personal-form">
                        @csrf
                        <input type="hidden" id="uploaded-profile-picture" name="uploaded_profile_picture" value="{{$member->personel_pic}}">
                        <div class="unique-form-row">
                            <div class="unique-form-group">
                                ...
                                <input value="{{$member->full_name}}" type="text" id="unique-firstname" name="unique-full-name" placeholder="Jake" required>
                            </div>
                        </div>
                        <div class="unique-form-row">
                            <div class="unique-form-group">
                                <label class="unique-label" for="unique-phone">Teléfono <span>*</span></label>
                                <input type="tel" id="unique-phone" value="{{$member->tel_1}}" name="unique-phone-1" placeholder="+44 1245 572 135" required>
                            </div>
                            <div class="unique-form-group">
                                <label class="unique-label" for="unique-email">Correo <span>*</span></label>
                                <input type="email" id="unique-email" value="{{$member->email}}" name="unique-email" placeholder="Jakegyll@gmail.com" required>
                            </div>
                        </div>
                        <div class="unique-form-row">
                            <div class="unique-form-group">
                                <label class="unique-label" for="unique-phone">Teléfono 2 (opcional) </label>
                                <input type="tel" id="unique-phone" value="{{$member->tel_2}}" name="unique-phone-2" placeholder="+44 1245 572 135">
                            </div>
                            <div class="unique-form-group">
                                <label class="unique-label" for="unique-email">Cargo <span>*</span></label>
                                <input type="text" id="unique-email"  value="{{$member->poste}}" name="unique-cargo" placeholder="Cargo" required>
                            </div>
                        </div>
                        </div>
                        <hr class="w-100 mt-18 " style="">
                            ...
                            <div class="job-search-options">
                                ...
                                <label class="job-search-option">
                                    <input type="radio" name="job-search" value="open" 
                                        {{ $additionalInfo === 'No estoy' ? 'checked' : '' }}>
                                    <div class="job-search-content">
                        ...
                        <div class="job-search-container">
                            ...
                            <div id="location-input-container" style="display: {{ $location === 'Trabajo2' ? 'block' : 'none' }}; margin-top: 10px;">
                                <label for="new-location">Nueva ubicación:</label>
                                <input type="text" id="new-location" name="new-location" placeholder="Ingrese la nueva ubicación" value="{{isset($member->location) ? $member->location : ''}}">
                            </div>
                        </div>
                        <hr class="w-100 mt-18" style="">
