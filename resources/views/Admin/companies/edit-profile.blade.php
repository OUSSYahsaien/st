...
@section('content')
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/Admin/company/edit-profile.css') }}">
    ...
    <body>
        ...
        <div class="EC-container">
            ...
            <div class="EC-tab-content" id="account" style="display: block; margin-top: -50px;">
                <div class="EC-content">
                    <section id="notifications" class="content-section">
                        ...
                        <div class="refresh-email-section">
                            ...
                            <div class="refresh-fields">
                                <div class="current-email">
                                        <p class="email-address">{{ $company->email }} 
                                ...
                                <div class="update-email-form">
                                    ...
                                    <form style="max-width: 400px;" method="post" action="{{ route('administration.company.edit.email') }}">
                                        @csrf
                        ...
                        <div class="change-password-section">
                            ...
                            <div class="password-fields">
                                <form style="" method="post" action="{{ route('administration.company.edit.password') }}">
                                    @csrf
                                    <input type="hidden" name="id_company" value="{{$company->id}}">
                        ...
                        <div class="notification-settings">
                            ...
                            <div class="settings-options">
                                <form method="POST" action="{{ route('company.update.preferences') }}">
                                    ...
                                    <div class="option">
                                        <label>
                                            <input type="checkbox" disabled name="first" value="yes" {{ isset($preferences) && $preferences->first === 'yes' ? 'checked' : '' }}>
                                    ...
                                    <div class="option">
                                        <label>
                                            <input type="checkbox" disabled name="second" value="yes" {{ isset($preferences) && $preferences->second === 'yes' ? 'checked' : '' }}>
                                            <span>Estos son permisos que el clientre tiene que dar</span>
                                        </label>
                                    ...
                                    <div class="option">
                                        <label>
                                            <input type="checkbox" disabled name="third" value="yes" {{ isset($preferences) && $preferences->third === 'yes' ? 'checked' : '' }}>
        ...
        <script>
            ...
            function confirmarDesactivacion() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'POST';
                        form.action = '{{route("administration.company.disactive.compte", ["id" => $company->id])}}';
            ...
            function confirmarActivasion() {
                Swal.fire({
                    title: '¿Estás seguro?',
                    text: "¿Quieres activar esta cuenta de empresa?",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        ...
                        const form = document.createElement('form');
                        form.method = 'POST';
                        form.action = '{{route("administration.company.active.compte", ["id" => $company->id])}}';
