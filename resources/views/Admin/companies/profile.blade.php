...
@section('content')
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/Admin/company/profile.css') }}">
        ...
        <main class="company-profile">
            ...
            <div class="mpage-header">
                <div class="tab-controls">
                    ...
                    <button class="tab active">Pagina de la empresa </button>
                  </a>
                  <a href="{{route('administration.companies.offersCompany', ['id' => $company->id ])}}">
                    <button class="tab">Ofertas Publicadas</button>
                  </a>
            ...
            <section class="profile-header">
                <div class="company-logo">
                    <img src="{{ $company->personel_pic && file_exists(public_path('images/companies_images/' . $company->personel_pic)) 
                    ? asset('images/companies_images/' . $company->personel_pic) 
                ...
                <div class="company-info">
                    <div class="company-info-header">
                        ...
                        <div class="settings-button">
                            <a href="{{ route('administration.companies.profile.edit', ['id' => $company->id]) }}" style="text-decoration: none;">
                    ...
                    @if ($company->website)
                        <a href="{{$company->website }}" class="company-website" id="websiteLink">{{$company->website }}</a>
                    @else
                    ...
                    <div class="company-stats">
                        <div class="stat-item">
                            ...
                            <span>Founded</span>
                            {{-- <p id="foundedDate">{{$company->date_de_fondation ? $company->date_de_fondation : "" }} 31 de julio de 2011</p> --}}
                            <p id="foundedDate">
                                @if($company->date_de_fondation)
                                    {{ \Carbon\Carbon::parse($company->date_de_fondation)->translatedFormat('d \d\e F \d\e Y') }}
                                @else
                    ...
                    @foreach($teamMembers as $teamMember)
                        <div class="team-card">
                            <div class="card-icons">
                                <a href="{{ route('administration.company.view.team.member', ['id' => $teamMember->id]) }}" class="social-link">
