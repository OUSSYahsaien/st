...
@section('content')
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/Admin/settings/sectors.css') }}">
    </head>
    <body>
        
        <div class="contai" style="margin-top: -42px;">
    
            <div class="title-h2">Gestión sectorial</div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach($sectors as $sector)
                                    <tr data-language-id="{{ $sector->id }}">
                                        <td data-label="Description" style="text-align: center;">{{ $sector->name }}</td>
                ...
                button.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            fetch(`/administration/sectors/${languageId}`, {
                                method: 'DELETE',
                                headers: {
                            ...
                            .catch(error => {
                                Swal.fire(
                                    'Error',
                                    'Hay un problema al eliminar el sector.',
                                    'error'
                                );
                            });
                        }
