...
@section('content')
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/Admin/offers/add-offer-1.css') }}">
    ...
    <body>
        ...
        <div class="conta">
            ...
            <header class="s-1-header" style="margin-top: -51px">
            ...
            <main class="form-container">
                ...
                <form id="jobForm" class="form" method="post" action="{{ route('administration.post.job.step.one') }}">
                    @csrf
                    <div class="form-group">
                        ...
                        <input class="form-input c-no-p" type="text" id="jobTitle" name="jobTitle" placeholder="Solution Architect" maxlength="20">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-input c-no-p" type="text" id="location" name="location" placeholder="Navarra" maxlength="20">
                        <span class="form-hint">Máximo 20 caracteres</span>
                    </div>
