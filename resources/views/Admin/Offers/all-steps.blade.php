...
@section('content')
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/Admin/offers/edit-offer.css') }}">
    ...
    <body>
        ...
        <div class="conta">
            ...
            <header class="h" style="margin-top: -120px">
            ...
            <main class="form-container">
                ...
                <form id="jobForm" class="form" method="post" action="{{ route('administration.edit.offer', ['id' => $offer->id]) }}">
                    @csrf
